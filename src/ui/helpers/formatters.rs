...
/// Returns the arrow label and color for a transfer direction.
///
/// Used consistently across panels (Files, Send) so direction indicators
/// are always rendered the same way.
pub fn direction_style(dir: TransactionDirection) -> (&'static str, Color) {
    match dir {
