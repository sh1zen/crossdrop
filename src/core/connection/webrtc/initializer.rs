...
use crate::core::config::{CONNECTION_TIMEOUT, DATA_CHANNEL_TIMEOUT, ICE_GATHER_TIMEOUT, SCTP_MAX_MESSAGE_SIZE};
...
use super::{
    ConnectionMessage, SignalingMessage, WebRTCConnection, WireStats,
};
    ...
    pub async fn accept_offer(
...

        {
            ...
            pc.on_data_channel(Box::new(move |dc| {
                ...
                Box::pin(async move {
                    attach_dc_handlers(
                        &dc, rs, pc_chunks, ad, atx, sk, ra, km, pr, crc, ws,
                    )
                    .await;
